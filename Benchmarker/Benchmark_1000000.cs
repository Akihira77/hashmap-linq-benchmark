    ...
    public void ListAndLINQ()
    {
        ...
        var nonExistingEntities = batchEntities
            ...
            .Where(e => !dbEntitiesList.Any(db =>
                ...
                && string.Equals(db.DistrictCode, e.DistrictCode)
                && string.Equals(db.SegmentBusinessName, e.SegmentBusinessName)
                && string.Equals(db.ParameterDescName, e.ParameterDescName))
            )
            .ToList();
